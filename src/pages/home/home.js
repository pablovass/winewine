    ...
    <div class="row">
      <div class="col-sm-4">
        ...
        <a href="#demo" data-toggle="collapse">
          <img src="images/1.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
        </a>
      ...
      <div class="col-sm-4">
        ...
        <a href="#demo2" data-toggle="collapse">
          <img src="images/10.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
        </a>
      ...
      <div class="col-sm-4">
        ...
        <a href="#demo3" data-toggle="collapse">
          <img src="images/11.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
        </a>
    ...
    <div class="row">
      <div class="col-sm-4">
        ...
        <a href="#demo4" data-toggle="collapse">
          <img src="images/13.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
        </a>
      ...
      <div class="col-sm-4">
        ...
        <a href="#demo5" data-toggle="collapse">
          <img src="images/15.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
        </a>
      ...
      <div class="col-sm-4">
        ...
        <a href="#demo6" data-toggle="collapse">
          <img src="images/44.jpg" class="img-circle person" alt="Random Name" width="255" height="255">
        </a>
  ...
  <div id="whiskey" class="bg-1">
    <div class="container">
      ...
      <div class="row text-center">
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="images/7.jpg" alt="Paris" width="400" height="300">
        ...
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="images/12.jpg" alt="New York" width="400" height="300">
        ...
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="images/44.jpg" alt="San Francisco" width="400" height="300">
      ...
      <div class="row text-center">
        ...
        <div class="col-sm-4">
          <div class="thumbnail">
            <img src="images/13.jpg" alt="San Francisco" width="400" height="300">
            <p><strong>San Francisco</strong></p>
            <p>Sunday 29 November 2015</p>
            <button class="btn" data-toggle="modal" data-target="#myModal">Buy Tickets</button>
          </div>

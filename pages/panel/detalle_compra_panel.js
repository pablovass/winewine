...
function getTodosLosTotales(){
    ...
    .then((data)=>{
      ...
      data.forEach(function(dato) {
        ...
        <td><button class="btn" data-toggle="modal" data-target="#myModal" onclick="window.location.href = '/pages/compra/compraDetalleRealizada.html?c=${dato.nro_compra}';">ver detalle</button></td>
        </tr>`;
